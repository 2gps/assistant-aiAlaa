...
const CONFIG = {
  MAX_HISTORY: 30,
  VISION_MODEL: 'llama-3.2-11b-vision-preview', // النموذج الصحيح للـ Vision
...
function getUserConversation(userId) {
  if (!userConversations[userId]) {
    ...
    const systemContent = isOwner 
      ? 'أنت بوت ذكي اسمك "3laa\'s Assistant" تم إنشاؤك بواسطة علاء الدين (مطورك ومالكك). أنت لست من Meta AI ولا من أي شركة أخرى - أنت بوت مستقل. فقط عندما يسألك أحد "من طورك؟" أو "من صنعك؟" أو "من مطورك؟"، أجب بـ "مطوري وصانعي هو علاء الدين". في باقي الأسئلة العادية، أجب مباشرة بدون ذكر المطور. يمكنك تحليل الصور والملفات، كتابة الأكواد، والبحث العميق. تجيب بدقة ووضوح.'
      : 'أنت بوت ذكي اسمك "3laa\'s Assistant" تم تطويرك بواسطة علاء الدين. أنت لست من Meta AI ولا من أي شركة أخرى - أنت بوت مستقل. فقط عندما يسألك أحد "من طورك؟" أو "من صنعك؟" أو "من المطور؟"، أجب: "مطوري هو علاء الدين". في الأسئلة العادية الأخرى، أجب مباشرة بدون ذكر المطور. يمكنك تحليل الصور والملفات، كتابة الأكواد، والبحث العميق. تجيب بدقة ووضوح.';
...
app.get('/', (req, res) => {
  ...
  res.json({
    status: 'online',
    bot: '3laa\'s Assistant',
    developer: 'Alaa Aldeen',
